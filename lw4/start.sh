...
docker run --detach --rm --env NATS_HOST=$NATS_HOST --env NATS_PORT=$NATS_PORT --env REDIS_HOST=$REDIS_HOST --env REDIS_PORT=$REDIS_PORT --env NATS_BUS=$NATS_BUS --link $NATS_HOST --link $REDIS_HOST --name textrankcalc textrankcalc:$1
